...
def getProducts():
    ...
    sql = "SELECT products.name, products.price, categories.name FROM products inner join categories on categories.id = products.categoryid WHERE categories.name = 'Telephone'"
